...
//
// Copied from JetBrains GeneratedParserUtilBase.java on 2023-02-12
 ...
 * @author gregsh
 */
public class ErlangParserUtilBase {
  private static final Logger LOG = Logger.getInstance(ErlangParserUtilBase.class);
