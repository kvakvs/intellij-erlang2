...
public class ErlPsiExprImpl extends ASTWrapperPsiElement implements ErlPsiExpr {

  public ErlPsiExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ErlPsiLiteralExpr getLiteralExpr() {
    return findChildByClass(ErlPsiLiteralExpr.class);
  }
