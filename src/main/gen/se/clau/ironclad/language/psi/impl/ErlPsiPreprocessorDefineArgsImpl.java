...
public class ErlPsiPreprocessorDefineArgsImpl extends ASTWrapperPsiElement implements ErlPsiPreprocessorDefineArgs {

  public ErlPsiPreprocessorDefineArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ErlPsiVisitor visitor) {
    visitor.visitPreprocessorDefineArgs(this);
  }
